...
/* harmony import */ var _modules_start_video__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./modules/start-video */ "./js/modules/start-video.js");
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  Object(_modules_start_video__WEBPACK_IMPORTED_MODULE_2__["initVideo"])();
  Object(_modules_tabs_js__WEBPACK_IMPORTED_MODULE_3__["changeTab"])();
  Object(_modules_slider_js__WEBPACK_IMPORTED_MODULE_4__["startSliders"])();
...
/*!******************************!*\
  !*** ./js/modules/slider.js ***!
  \******************************/
/*! exports provided: coachSlider, reviewsSlider, startSliders */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "coachSlider", function() { return coachSlider; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "reviewsSlider", function() { return reviewsSlider; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "startSliders", function() { return startSliders; });
...
var coachSlider;
var reviewsSlider;
var addFocusOnSlide = function addFocusOnSlide() {
  var slider = document.querySelector('.coachs__slider');
...
var startSliders = function startSliders() {
  if (document.querySelector('.coachs__slider')) {
    var coachsWrapper = document.querySelector('.coachs__swiper-wrapper');
    var coachsButtonPrev = document.querySelector('.coachs__slider-button-prev');
    var coachsButtonNext = document.querySelector('.coachs__slider-button-next');
    ...
    coachSlider.on('slideChange', function () {
      addFocusOnSlide();
    });
    addFocusOnSlide();
  }
  if (document.querySelector('.reviews__slider')) {
    var reviewsWrapper = document.querySelector('.reviews__swiper-wrapper');
    var reviewsButtonPrev = document.querySelector('.reviews__slider-button-prev');
    var reviewsButtonNext = document.querySelector('.reviews__slider-button-next');
...
var videoContainer = document.querySelector('.about__video');
var startPlay = function startPlay() {
  var videoCover = videoContainer.querySelector('img');
  var videoButton = videoContainer.querySelector('button');
  if (videoContainer.dataset.videoSrc) {
    var videoUrl = videoContainer.dataset.videoSrc;
    ...
    _video.innerHTML = '<p style="background-color: #000000; color: red; width: 100%; height: 100%; font-weight: 700; margin: 0; text-align: center">Видео недоступно</p>';
...
var buttons = document.querySelectorAll('.subscription__tab-title-item');
var tabs = document.querySelectorAll('.subscription__tab-list');
var onClickTab = function onClickTab(tabNumber) {
...
var changeTab = function changeTab() {
  if (subscriptionBlock && buttons.length > 0 && tabs.length > 0) {
    if (buttons.length === tabs.length) {
      ...
      var prices = subscriptionBlock.querySelectorAll('b');
